...
public class GreetingsController {
    ...
    @ResponseBody
    public ResponseEntity<List<Usuario>> buscarPorNome(@RequestParam(name = "name") String name){//poderia deixar os dois @RequestBody @RequestParam
    	List<Usuario> user = usuarioRepository.buscaPorNome(name.trim().toUpperCase());
